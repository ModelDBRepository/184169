'''
Current clamp demo using Allen Brain's model 472301074.
...
from neuron472301074 import Neuron472301074
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472301074(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472301074; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-87.8744049072)
        h.fcurrent()
